...
namespace MediaButler.Data.Migrations
{
    ...
    [Migration("20250920055856_ConfigurationSettingsPrimaryKeyUpdate")]
    partial class ConfigurationSettingsPrimaryKeyUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MediaButler.Core.Entities.ConfigurationSetting", b =>
                {
                    ...
                    b.HasIndex("IsActive")
                        .HasDatabaseName("IX_ConfigurationSetting_IsActive");

                    b.HasIndex("LastUpdateDate")
                        .HasDatabaseName("IX_ConfigurationSetting_LastUpdateDate");

                    b.HasIndex("IsActive", "LastUpdateDate")
                        .HasDatabaseName("IX_ConfigurationSetting_IsActive_LastUpdateDate");

                    b.HasIndex("LastUpdateDate", "Section")
                        .IsDescending(true, false)
                        .HasDatabaseName("IX_ConfigurationSettings_Recent_Changes")
                        .HasFilter("[IsActive] = 1");

                    b.HasIndex("RequiresRestart", "LastUpdateDate")
                    ...
                    b.HasIndex("DataType", "Section", "IsActive")
                        .HasDatabaseName("IX_ConfigurationSettings_DataType_Section")
                        .HasFilter("[IsActive] = 1");

                    b.ToTable("ConfigurationSettings", null, t =>
                        {
