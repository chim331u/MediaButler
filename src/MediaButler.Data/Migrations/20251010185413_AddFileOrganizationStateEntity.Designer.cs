...
namespace MediaButler.Data.Migrations
{
    ...
    [Migration("20251010185413_AddFileOrganizationStateEntity")]
    partial class AddFileOrganizationStateEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MediaButler.Core.Entities.FileOrganizationStateEntity", b =>
                {
                    ...
                    b.HasIndex("CreatedDate")
                        .HasDatabaseName("IX_FileOrganizationStateEntity_CreatedDate");
                    ...
                    b.HasIndex("IsActive")
                        .HasDatabaseName("IX_FileOrganizationStateEntity_IsActive");

                    b.HasIndex("LastUpdateDate")
                        .HasDatabaseName("IX_FileOrganizationStateEntity_LastUpdateDate");

                    b.HasIndex("IsActive", "LastUpdateDate")
                        .HasDatabaseName("IX_FileOrganizationStateEntity_IsActive_LastUpdateDate");

                    b.HasIndex("State", "StateUpdatedAt")
                        .HasDatabaseName("IX_FileOrganizationStates_State_UpdatedAt")
                        .HasFilter("[IsActive] = 1");

                    b.HasIndex("State", "StateUpdatedAt", "IsActive")
            ...
            modelBuilder.Entity("MediaButler.Core.Entities.TrackedFile", b =>
                {
                    ...
                    b.HasIndex("Status", "Category", "CreatedDate")
